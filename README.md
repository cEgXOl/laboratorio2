...
```
![Verificar Base de Datos](./img/01_crear_database.png)
...
![Crear view](./img/02_crear_tablas.png)
...
![Validar view](./img/03_insertar_datos.png)
...
![Creación stored procedure](./img/04_tabla_temporal.png)
...
![Comprobar stored](./img/05_historial_precios.png)
...
![Crear una scalar function](./img/06_json_metadata.png)
...
![Utilizar scalar function](./img/07_consulta_json.png)
...
![Crear TVF](./img/08_particionado.png)
...
![Consultar TVF](./img/09_consulta_particiones.png)
...
![Combinar TVF con clientes](./img/10_sequence.png)
...
![Crear un trigger](./img/11_orderdetail.png)
...
![Comprobación trigger](./img/12_constraint_error.png)
